    ...
    def ui(self, outlet):
        ...
        def validate_lora(lora):
            ...
            if status:
                ...
                gr.Error("LoRA Triggers incorrectly!")

        with gr.Blocks():
            chara_version = gr.Dropdown(label="Template ver.", choices=["v3", "v6 (NOT RELEASED)"], value="v3", interactive=False)
