...
class ForeverGenerationFromLoRA(ForeverGenerationTemplate):
    ...
    async def start(
        ...
        rp_base_ratio = 0.5,
        lora_base = False,
        add_lora_name_base = False,
        lora_weight_base = 1.0,
        header_base = "",
        footer_base = "",
        max_tags_base = 1,
        base_chance_base = 0.0,
        disallow_duplicate_base = False,
        matrix_split = False,
        matrix_divide = False,
        matrix_canvas_res_auto = False,
        matrix_canvas_res = 512,
        lora_stop_step = 0,
        overlay_ratio = 0.5,
